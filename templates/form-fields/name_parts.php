...
$fplant_field_class = 'fplant-field fplant-field-name-parts';
...
if ( '3' === $fplant_name_format ) {
	// 3 parts: ja = family, middle, given / other = given, middle, family
	...
	// 2 parts (default): ja = family, given / other = given, family
	$fplant_parts_order = $fplant_is_ja
		? array( 'family', 'given' )
		: array( 'given', 'family' );
}
